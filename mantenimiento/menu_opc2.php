...
<div class="transition-all" style="padding: 20% 10%;">
    <div class="box">
        <img src="https://oliansa.com.mx/img/LOGO%20OLIANSA%20FINAL.png" width="100%;">
    </div>
</div>
...
<!-- CALIDAD -->
<li id="">    
    <a href='index.php?vista=menu_calidad' title="Calidad" id="toggle-btn-prod" style="cursor:pointer;">
        <span class="fa fa-calculator"></span> Calidad
    </a>
</li>
...
<a href="index.php?vista=menu_mtto" title="Mantenimiento" style="cursor:pointer;"><span class="fa fa-wrench"></span> Mantenimiento</a>
 ...
 <!-- USUARIOS -->
 <li id="">    
    <a href='index.php?vista=menu_sistemas' title="Sistemas" id="toggle-btn-prod" style="cursor:pointer;">
        <span class="fa fa-laptop"></span> Sistemas
    </a>
</li>
