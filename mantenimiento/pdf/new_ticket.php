...
$MST_ID=$_GET['idtickets'];

$inv_mst_query = "  SELECT idordenes, created_at, semana, nombre, codigo, departamento, falla, mecanico, usuario 
 FROM ordenes inner join equipos on maquina = ordenes.maquina where idordenes ='".$MST_ID."' ";             
...
if($count>0) 
{
    ...
    <td colspan="2" align="center">Maquina:</td>
        <td width="120" align="center">'.$inv_mst_data_row['nombre'].'<hr/></td>
        <td width="70" align="center">&nbsp;</td>
