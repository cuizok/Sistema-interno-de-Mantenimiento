...
<div class="container-fluid">
           ...
           <div class="row">
            <div class="col-xl-3 col-md-6">
              <div onclick="window.location.href='index.php?vista=ordenes_list_mtto'" class="card btnmenu text-gray mb-4" style="background-color: #b9ddc8; color:black;cursor:pointer;">
           ...
           <div class="row">
            <div class="col-xl-3 col-md-6">
              <div onclick="window.location.href='index.php?vista=category_list'" class="card btnmenu text-gray mb-4" style="background-color: #b9ddc8; color:black;cursor:pointer;">
                <div class="card-body">Inventario de Maquinaria</div>
                <div class="card-footer d-flex align-items-center justify-content-between">
                  <span class="small text-gray"></span>
                  <div class="small text-gray"><i class="fa fa-angle-right"></i></div>
                </div>
        ...
        <div class="container-fluid">
           ...
           <div class="row">
            <div class="col-xl-3 col-md-6">
              <div onclick="window.location.href='index.php?vista=programacion_mtto'" class="card btnmenu text-gray mb-4" style="background-color: #b9ddc8; color:black;cursor:pointer;">
