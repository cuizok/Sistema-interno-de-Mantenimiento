    ...
    <div class="col-sm-3">
        <div class="form-group">
            ...
            <select class="form-control" name="vista" required onchange="document.getElementById('statusForm').submit();">
                <option value="" selected="">CERRADO</option>
...
function redirectPage() {
    ...
    if (status) {
        ...
        switch (lowercaseStatus) {
            case "cerrado":
            case "en proceso":
            case "activo": // Agregado por si deseas mantener el comportamiento anterior para "activo"
                url += lowercaseStatus;
                break;
            default:
...
FROM  ordenes WHERE ESTATUS = 'CERRADO' ORDER BY idordenes DESC ";             
