...
<div class="card mb-4" id="tblPrincipal" style="width:100%">
        <div class="card-body" align="left"> 
            <div class="table-responsive" style="width:100%;">
                    ...
                    <a href="index.php?vista=nuevo_ticket2" class="btn btn-outline-light" id="nuevaOV" style="background-color:#4e84a9;color:white;float:right;margin-bottom:1rem;" role="button">
				...
				while($data_row = mysqli_fetch_array($results, MYSQLI_ASSOC))
				{
				 ...
				 <tr>
                    ...
                    <td><?php echo $data_row['prioridades']; ?></td>
                     ...
                     <a href="index.php?vista=revision_ticket&category_id_up=<?php echo $data_row['idtickets']; ?>&ACTION=VIEW" class="btn btn-success"><i class="fa fa-pencil-square-o"></i> </a> &nbsp;&nbsp; 
