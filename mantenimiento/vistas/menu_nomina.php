...
<div class="card mb-4" id="tblPrincipal" style="width:100%; margin-bottom: 20px;">
...
$url = "index.php?vista=menu_nomina&page=";
...
if ($totalPaginas > 1) {
    ...
    $maxPaginasMostradas = 10; // Cantidad de numeros de página que se mostrarán
    $espacioEntreNumeros = 0; // Espacio entre cada número de página
    ...
    for ($i = $inicio; $i <= $fin; $i++) {
        ...
        if ($i < $fin) {
            echo str_repeat('&nbsp;', $espacioEntreNumeros); // Agrega espacio entre números de página
        }
    }
