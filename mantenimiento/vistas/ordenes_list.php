        ...
        <form id="statusForm">
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <select class="form-control" id="estatus" name="estatus" required onchange="redirectPage()">
...
function redirectPage() {
    ...
    if (status) {
        ...
        // Verificar el estado seleccionado y construir la URL en consecuencia
        switch (lowercaseStatus) {
            case "cerrado":
            case "en proceso":
            case "abierto": // Agregado por si deseas mantener el comportamiento anterior para "activo"
                url += lowercaseStatus;
                break;
            default:
                // Si el estado no coincide con ninguno de los anteriores, redirige a "activo" por defecto
                url += "abierto";
                break;
        }
    ...
    <div class="row">
        <div class="col-lg-12" align="center">
            ...
            <table class="table table-striped">
                ...
                $estatus = strtoupper($vista);

                // Construir la consulta SQL según la vista seleccionada
               {
