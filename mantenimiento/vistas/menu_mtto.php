...
<div class="container-fluid">
           ...
           <div class="row">
            <div class="col-xl-3 col-md-6">
              <div onclick="window.location.href='index.php?vista=ordenes_list'" class="card btnmenu text-gray mb-4" style="background-color: #b9ddc8; color:black;cursor:pointer;">
        ...
        <div class="container-fluid">
           ...
           <div class="row">
            <div class="col-xl-3 col-md-6">
              <div onclick="window.location.href='index.php?vista=programacion_mantenimiento'" class="card btnmenu text-gray mb-4" style="background-color: #b9ddc8; color:black;cursor:pointer;">
