...
<div class="container-fluid" align="center" >
    ...
    <div class="container-fluid">    
           <div class="row">
            <div onclick="window.location.href='index.php?vista=piochas'" class="col-xl-3 col-md-6 " style="cursor:pointer;">
           ...
           <!-- <div class="col-xl-3 col-md-6">
              <div onclick="window.location.href='index.php?vista=avances_po'" class="card btnmenu text-gray mb-4" style="background-color:#ebeafe; color:black;cursor:pointer;">
            ...
            <div class="col-xl-3 col-md-6">
              <div onclick="window.location.href='index.php?vista=tickets_produccion'" class="card btnmenu text-gray mb-4" style="background-color:#ebeafe; color:black;cursor:pointer;">
            ...
            <div onclick="window.location.href='index.php?vista=ordenes_lista'" class="col-xl-3 col-md-6 " style="cursor:pointer;">
              <div class="card btnmenu mb-4" style="background-color:#ebeafe; color:black;">
                ...
                <div onclick="window.location.href='index.php?vista=menu_nomina'" class="col-xl-3 col-md-6 " style="cursor:pointer;">
              <div class="card btnmenu mb-4" style="background-color:#ebeafe; color:black;">
